...
* The original package name 'com.vijay.spring.basics.spring- first-project' is invalid and this project uses 'com.vijay.spring.basics.spring.firstproject' instead.
